...
/**
 * merge_sort - A function which sorts an array using merge algorithm.
 * @array: array to sort.
...
/**
 * merge - A function which sorts the subarrays.
 * @lo: Lower index.
 * @mi: Middle index.
 * @hi: Higher index.
...
/**
 * merge_partition - A funtion which splits the array recursively.
 * @lo: Lower index.
 * @hi: Higher index.
